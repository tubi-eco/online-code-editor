...
var textareaContent = document.querySelector('.textarea-code');
var codeIframe = document.getElementById('code');

var showCodePreview = function showCodePreview() {
  code.open();
  code.writeln("".concat(html.value, "<style>").concat(css.value, "</style>") + "<script>".concat(js.value, " </script>"));
  code.close();
  saveBtn.classList.remove("active");
  runBtn.classList.remove("active");
  localStorage.setItem("codeHtml", "".concat(html.value, "<style>").concat(css.value, "</style>") + "<script>".concat(js.value, " </script>"));
};

var compile = function compile(e) {
...
var minimizeContent = function minimizeContent() {
